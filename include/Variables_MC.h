...
// Thu Feb  2 14:42:36 2012 by ROOT version 5.26/00c
// from TTree orange/orange tree
// found on file: zeusmc.ydsne25.e11911.nc.dja.ari.5d.05e.5000.0008.root
//////////////////////////////////////////////////////////
...
public :
 ...
 //  Int_t           Trk_id2[400];   //[trk_ntracks]
   ...
   Float_t         Trk_helpar[400][5];   //[trk_ntracks]
   Float_t         Trk_covmat[400][15];   //[trk_ntracks]
   Float_t         Trk_helmom[400];   //[trk_ntracks]
...
//    Float_t         Vcatcal_p[450][3];   //[vcatcal_n]
   ...
   Int_t           Trkmsa_id[200];   //[trkmsa_ntracks]
   Float_t         Trkmsa_px[200];   //[trkmsa_ntracks]
   Float_t         Trkmsa_py[200];   //[trkmsa_ntracks]
   Float_t         Trkmsa_pz[200];   //[trkmsa_ntracks]
   Float_t         Trkmsa_charge[200];   //[trkmsa_ntracks]
   Int_t           Trkmsa_ndof[200];   //[trkmsa_ntracks]
   Float_t         Trkmsa_chi2[200];   //[trkmsa_ntracks]
   Int_t           Trkmsa_nbr[200];   //[trkmsa_ntracks]
   Int_t           Trkmsa_nbz[200];   //[trkmsa_ntracks]
   Int_t           Trkmsa_nwu[200];   //[trkmsa_ntracks]
   Int_t           Trkmsa_nwv[200];   //[trkmsa_ntracks]
   Float_t         Trkmsa_dedxmvd[200];   //[trkmsa_ntracks]
   Float_t         Trkmsa_helpar[200][5];   //[trkmsa_ntracks]
   Float_t         Trkmsa_covmat[200][15];   //[trkmsa_ntracks]
   Float_t         Trkmsa_helmom[200];   //[trkmsa_ntracks]
   Float_t         Trkmsa_imppar[200];   //[trkmsa_ntracks]
   Float_t         Trkmsa_imperr[200];   //[trkmsa_ntracks]
   Float_t         Trkmsa_pca[200][3];   //[trkmsa_ntracks]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("zeusmc.ydsne25.e11911.nc.dja.ari.5d.05e.5000.0008.root");
      if (!f) {
         f = new TFile("zeusmc.ydsne25.e11911.nc.dja.ari.5d.05e.5000.0008.root");
      }
