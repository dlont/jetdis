...
// Thu Aug 16 18:30:01 2012 by ROOT version 5.26/00c
// from TTree h1/ORANGE
// found on file: /data/zenith238d/jbehr/highq2/rootntuple/pos_noz0/0.root
//////////////////////////////////////////////////////////
...
public :
   ...
   Float_t         Sifmaxbemc[4];   //[Sincand]
   Float_t         Sifmaxremc[4];   //[Sincand]
   Float_t         Sifmaxfemc[4];   //[Sincand]
   Float_t         Sideltaz[4];   //[Sincand]
   Float_t         Sideltax[4];   //[Sincand]
   Float_t         Sideltay[4];   //[Sincand]
   ...
   UChar_t         trk_dedxctdsaturated[400];   //[trk_ntracks]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/data/zenith238d/jbehr/highq2/rootntuple/pos_noz0/0.root");
      if (!f) {
         f = new TFile("/data/zenith238d/jbehr/highq2/rootntuple/pos_noz0/0.root");
      }
